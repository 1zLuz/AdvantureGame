...
public class GrassOne {
    private final Image grassImage;
    private final int grassX;
    private final int grassY;
    private final int grassSize;

    public GrassOne(int grassX, int grassY, int grassSize) {
        grassImage = new ImageIcon("res/tiles/1.png").getImage().getScaledInstance(64, 64, Image.SCALE_SMOOTH);
        this.grassX = grassX;
        this.grassY = grassY;
