...
public class DirtSix {
    private final Image dirtImage;
    private final int dirtX;
    private final int dirtY;
    private final int dirtSize;

    public DirtSix(int dirtX, int dirtY, int dirtSize) {
        dirtImage = new ImageIcon("res/tiles/6.png").getImage().getScaledInstance(64, 64, Image.SCALE_SMOOTH);
        this.dirtX = dirtX;
        this.dirtY = dirtY;
